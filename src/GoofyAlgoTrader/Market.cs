...
namespace GoofyAlgoTrader
{
    public static class Market
    {
        ...
        public static void Add(string market, int identifier)
        {
            if (identifier >= MaxMarketIdentifier)
            {
                throw new ArgumentOutOfRangeException(nameof(identifier),
                    $"The market identifier is limited to positive values less than {MaxMarketIdentifier}."
                );
            }
        ...
        public static int? Encode(string market)
        {
            lock (_lock)
            {
                return !Markets.TryGetValue(market, out int code) ? (int?)null : code;
            }
        }
        ...
        public static string Decode(int code)
        {
            lock (_lock)
            {
                return !ReverseMarkets.TryGetValue(code, out string market) ? null : market;
            }
        }
    }
}
